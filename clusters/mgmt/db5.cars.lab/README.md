...
export TELCO_MGMTCLUSTER_PATH=~/rhocp-castor/clusters/mgmt/db5.cars.lab
...
- Create secret from pull-secret for the Assisted Installer Operator:
    ...
    ```bash
    oc create secret generic assisted-deployment-pull-secret -n assisted-installer --from-file=.dockerconfigjson=/home/redhat/pull-secret-original.json --type=kubernetes.io/dockerconfigjson
    ```
...
This is output from a working management cluster (DB5) from September 2021 with versions at the time:
